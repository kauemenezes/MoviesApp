package br.com.moviesapp.repository
...
class MoviesRepositoryTest {
    ...
    fun createDb() {
        ...
        moviesRepository = MoviesRepositoryImpl(moviesDataSource, TestCoroutineDispatcher())
    ...
    fun getMovies_confirmObtained() = runBlocking {
        ...
        moviesRepository.getMovies().take(1).collect {
            MatcherAssert.assertThat(it, CoreMatchers.not(emptyList()))
            MatcherAssert.assertThat(it, IsCollectionWithSize.hasSize(2))
        }
    }
